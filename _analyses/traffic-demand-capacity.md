...
findings:
  ...
  - Culebra and Potranco have similar V/C ratios but Culebra ranks far worse on delay — its signal density amplifies the same structural overload into disproportionate lost time
methods:
...
(function() {
  var segments = [
    ...
    { name: "N PanAm Expy / IH 35", sub: "Loop 1604 NE → Loop 410", vc: 1.60, aadt: 182704, cap: 114000, project: "I-35 NEX expansion", year: 2030 },
    { name: "PanAm Expy / IH 35 / IH 10", sub: "Loop 410 → downtown", vc: 1.54, aadt: 175000, cap: 114000, project: "PanAm Expressway improvements", year: 2029 },
    { name: "IH 35", sub: "Schertz/Cibolo, NE of Loop 1604", vc: 1.54, aadt: 175955, cap: 114000, project: "I-35 NEX expansion", year: 2030 },
    { name: "Potranco Rd / FM 1957", sub: "Loop 410 → Loop 1604 area", vc: 1.40, aadt: 50452, cap: 36000, project: null, year: null },
    ...
    { name: "McDermott Fwy / IH 10 / US 87", sub: "East side", vc: 1.20, aadt: 182315, cap: 152000, project: null, year: null },
    { name: "Jose Lopez Fwy / IH 10 / US 90", sub: "West side", vc: 1.05, aadt: 159709, cap: 152000, project: "I-10 West managed lanes", year: 2027 },
  ];

  function vcColor(vc) {
    if (vc >= 1.1) return "#b33225";
  ...
  function badge(vc) {
    ...
    var bg = vc >= 1.1 ? "#fdf0ee" : vc >= 0.85 ? "#fdf5e6" : "#eef5ec";
